...
DEFAULT_OUTPUT_DIR = Path(os.getenv("MX_OUTPUT_DIR", Path.home() / ".codex" / "skills-output" / "mx_data" / "output"))
...
def main():
    ...
    parser.add_argument("--output-dir", dest="output_dir", help=f"输出目录，默认 {DEFAULT_OUTPUT_DIR}")
